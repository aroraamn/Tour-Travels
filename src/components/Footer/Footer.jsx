            ...
            <div className="footerCard flex">
                <div className="footerIntro flex">
                    <div className="logoDiv">
                        <a href="/Navbar.jsx" className="logo flex">
                           < SiYourtraveldottv className = "icon" /> Travel.
                        </a>
                    </div>
                    <div data-aos = "fade-up" className="footerParagraph" >
                        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nesciunt animi mollitia ex quaerat optio aperiam aspernatur corrupti cum quo consequuntur? Eligendi provident veritatis quam expedita adipisci magni velit maxime pariatur.
                    </div>
